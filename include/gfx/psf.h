...
static const uint8_t OX_DEFAULT_PSFDATA[] = 
{
...
static const OX_PCScreenFont OX_DEFAULT_PSF = { (OX_PSFHdr*)OX_DEFAULT_PSFDATA, (uint8_t*)OX_DEFAULT_PSFDATA, 1, 0 };
